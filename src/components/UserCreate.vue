<template>
  <form class="new-profile" v-cloak>
    <div class="control">
      <h2>Новый пользователь</h2>
      <div class="btns-group">
        <button type="submit" class="btn btn-green btn-default" @click.prevent="createProfile">
          Сохранить
        </button>
    ...
    <fieldset>
      ...
      >
          <picture v-show="image.value.length > 0">
            <img :src="image.value" height="326px" :alt="image.value ? 'First avatar' : ''">
          </picture>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      resetData,
      createProfile: async () => {
        await store.dispatch("profiles/createProfile", { ...form });
        resetData()
      },
    };
  },
